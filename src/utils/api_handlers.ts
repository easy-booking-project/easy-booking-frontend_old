...
export async function signIn({ username, authenticationHash }: UserSignInInfo) {
  return fetch(`${ServerInfo.BASE_URL}/authentication/sign-in`, {
    method: 'POST',
    headers: {
...
export async function signUp(payload: Partial<UserSignUpInfo>) {
  return fetch(`${ServerInfo.BASE_URL}/authentication/sign-up`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function fetchUser() {
  return fetch(`${ServerInfo.BASE_URL}/user/fetch`, {
    method: 'GET',
    credentials: 'include',
  });
}
...
export async function signOut() {
  return fetch(`${ServerInfo.BASE_URL}/authentication/sign-out`, {
    method: 'POST',
    credentials: 'include',
  });
}
